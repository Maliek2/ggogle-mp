...
export default function BlogPage() {
  ...
  return (
    <div>
      ...
      <h1>The Blog (Hybrid AMP Page)</h1>
      <Byline author="LatestTrends" />
      <p>
        <a href={isAmp ? '/blog' : '/blog?amp=1'}>
          {isAmp ? 'View Non-AMP' : 'View AMP'} Version
        </a>
      </p>
      <p className="caption">Support the youth</p>
      <p>
        Wafer donut candy soufflé{' '}
        <a href={isAmp ? '/?amp=1' : '/'}>Advertisements</a> icing. Marzipan gummi
      ...
      <p>
        Ice cream {' '}
        <a href={isAmp ? '/blog?amp=1' : '/partners'}>Partners</a> are  lollipop marshmallow tiramisu jujubes croissant. Bear claw
